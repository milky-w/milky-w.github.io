...
把连续的符号相同的数缩成一个数，去掉两端的非正数，得到一个正负交替的序列，把该序列中所有数的绝对值扔进堆中，用所有正数的和减去一个最小值，这个最小值的求法与「[CTSC 2007 数据备份](https://milky-w.github.io/oi/2018/10/21/CTSC-2007-%E6%95%B0%E6%8D%AE%E5%A4%87%E4%BB%BD/)」的做法相同。
